...
begin
  ...
  if test_plan_id is null then
    raise exception 'No paid plan found for Arthur WhatsApp test number';
  end if;
  ...
  values (
    ...
    'manual-whatsapp-test-customer-554498924520',
    'manual-whatsapp-test-subscription-554498924520',
    now(),
